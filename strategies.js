var strategies = [
            ...
            "How large was the Great Migration of the 20th century and what were its motivations?",
            ...
            "Look up a map of redlining in New Deal America.",
            "How did the Federal Housing Administration historically enforced segregation?",
            ...
            "What is one of your favorite examples of Black love?",
            "Which state had the first Black Governor? When?",
            "Gift a white child your favorite childrens' book that centers on a Black character.",
            ...
            "How many of your teachers, bosses, or coaches were Black growing up?",
            ...
            "What is race?",
            "On what grounds do you feel equipped to speak about what it's like to be Black in America?",
            "How were Black families held together during slavery?",
            ...
            "How many of your favorite painters are Black?",
            "What is Juneteenth?",
            "Center Black voices in your day.",
            "Be willing to be wrong, and learn to grow.",
            "What is the difference between systematic and systemic?",
            "How does your vote connect to the criminal justic system?",
            "What are the responsibilities of a mayor?",
            "What are the responsibilities of a sheriff?",
            "Who is your local sheriff?",
            "What do district attorneys do? Who are yours?",
            "What are the responsibilities of a governor?",
            "What are state legilators responsible for? Who are yours?",
            "Who are your senators and representatives in Congress?",
            "Read an article able environmental racism.",
            "What was the role of Black musicians in the history of your favorite genre?",
            "What is colonialism?",
            "Learn about WWII reparations and draw analogies.",
            "'People enslaved' not 'slaves'",
            "Stolen from home, family, language, dreams. Shipped inhumanely for months around the world. Sold. Abused. Forced to work.",
            "Have you ever imagined, to any substantive degree, what it be like to be enslaved?",
            "How does colonialism exist in your profession?",
            "How long do you expect it to take to fix systemic racism?",
            "Read a book by a Black author.",
            "What are the central asks of HR-40?",
            "Write three sentences to dispute that you 'one of the good white people.'",
            "Name 5 Black women you learned about in History class. Learn about 5 more."
            ];
